...
import airoportsinfo.controllers.json.dto.PageParam;
...
@WebServlet(name = "FlightsServletJson", urlPatterns = "/json/flights")
public class FlightsServletJson extends HttpServlet {
    IFlightsFilterService flightsFilterService;
    private ObjectMapper mapper = new ObjectMapper();
    IFlightsService flightsService;
    public FlightsServletJson() {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        PageParam pageParam = new PageParam(flights, filtersList, filtersAll);
        String writeValueAsString = mapper.writeValueAsString(pageParam);

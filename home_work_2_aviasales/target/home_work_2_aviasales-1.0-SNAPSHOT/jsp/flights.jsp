...
<body>
    <div>
        <form action="${pageContext.request.contextPath}/flights" method="get">
            ...
            <p>Дата вылета
                <input type="date" name="scheduledDeparture" value=${scheduledDeparture2}>
            </p>
            <p>Дата прибытия
                <input type="date" name="scheduledArrival" value=${scheduledArrival2}>
            </p>

            <p><input name="page" value="Search" type="submit"></p>
